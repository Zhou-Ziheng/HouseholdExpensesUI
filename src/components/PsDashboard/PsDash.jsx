    ...
    return (
        <>
            ...
            <Modal show={show} onHide={handleClose} className="w-screen h-screen">
                ...
                <Modal.Footer>
                    <button className="bg-[#8b74bd] px-3 py-3 rounded text-white" variant="secondary" onClick={handleClose}>
                        Close
                    </button>
                    <button className="bg-[#8b74bd] px-3 py-3 rounded text-white" variant="primary" onClick={handleClose}>
                        Add Expenses
                    </button>
                </Modal.Footer>
            </Modal>
