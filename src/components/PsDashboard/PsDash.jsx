        ...
        <>
            ...
            <div class="my-[-25px] mx-[-175px] rounded relative sm:rounded-lg">
                <table class="w-4/6 text-sm mx-auto text-left text-gray-500 rounded dark:text-gray-400">
                    <caption class="p-5 text-lg font-semibold rounded text-left text-gray-900 bg-white dark:text-white dark:bg-[#8b74bd]">
                        Expenses
                        <p class="mt-1 text-sm font-normal text-gray-200 dark:text-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            <th scope="row" class="py-4 px-6 font-bold text-xl text-gray-900 whitespace-nowrap dark:text-white ">
                                TOTAL
                            </th>
