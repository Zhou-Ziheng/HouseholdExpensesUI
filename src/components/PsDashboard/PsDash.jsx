...
export default function PsDash({ loggedin, id }) {
    ...
    const handleUtilitiesShow = (header) => { setHistory(map.current.get(header.toUpperCase())); setHead(header); setUtilitiesShow(true) };
        ...
        headers.forEach((header) => {
            ...
            render.push(
                <tr class="bg-gray-800 border-gray-700">
                    ...
                    >
                        <a onClick={() => handleUtilitiesShow(header)} href="#" className="font-bold text-white">{header}</a>
                    </th>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Form.Control as="textarea" rows={5} placeholder="Give A Brief Description" />

                        <Form.Group className="mt-3" controlId="ControlInput1">
                            <Form.Label>Amount</Form.Label>
                        </Form.Group>
                        <Form.Control type="number" placeholder="Insert Amount" autoFocus />
